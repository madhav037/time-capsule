    ...
    <>
      <div className="p-4 bg-[#C8CFA0] grid grid-cols-2 content-center ">
        ...
        <Link to={'/'} className="hover:cursor-pointer">
          <label className="text-red-500 font-bold text-3xl hover:cursor-pointer">T</label>
          <label className="text-red-400 font-bold text-2xl hover:cursor-pointer">ime</label>
          <label className="text-red-500 font-bold text-3xl hover:cursor-pointer">C</label>
          <label className="text-red-400 font-bold text-2xl hover:cursor-pointer">apsule</label>
        </Link>
        </div>
        <div className="flex justify-end me-2 items-center font-medium ">
        <Link to={'/letters/new'} className="hover:border-b-4 border-red-300 border-b-4 p-2 cursor-pointer mx-5 hover:border-red-400 rounded-sm flex flex-row">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style={{width:'18px', marginRight:'10px' }}>
